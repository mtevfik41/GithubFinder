          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <ul class="list-group">
                ...
                <li class="list-group-item">Member Since: ${this.months[new Date(user.created_at).getMonth()] +
            "-" +
            ...
            new Date(user.created_at).getFullYear()
              ...
              <br>
              <span class="badge badge-${user.hireable ? "success" : "danger"
            }">Available for hire : ${user.hireable ? "Yes" : "No"}</span>
              ${user.twitter_username ? `<span class="badge badge-info"><a href="https://twitter.com/${user.twitter_username}" class="text-white" target="_blank">Follow on Twitter</a></span>`
                : ""
            }
            </div>
          </div>
